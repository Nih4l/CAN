...
const HealthCard1 = () => {
  ...
  return (
    <Page
      pageContent={
        <>
          <div className='h-fit w-full bg-[#FEF8FD] flex flex-col gap-4 pb-5'>
            ...
            <div className='ml-[13%] h-full w-[80%] bg-white rounded-xl p-2'>
              ...
              <div className='flex flex-row items-end justify-end mx-16 p-4'>
                <div className='flex flex-row gap-3'>
                  ...
                  <div className='h-10 w-28 bg-[#EFC319] text-[#FFFF] rounded-xl flex items-center justify-center cursor-pointer'>
                    Save
                  </div>
                </div>
              </div>
