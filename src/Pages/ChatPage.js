              ...
              <div className="h-[85%] w-[85%] bg-white rounded-3xl overflow-hidden shadow-2xl">
                <div className="flex">
                  ...
                  <div className="pt-4 px-4 h-[80vh] w-[25%] border-r-2">
                    ...
                    <div className=" flex pt-3 justify-between px-5 relative">
                      <div
                        className={
                          chats
                            ? "font-bold text-[#8B1539] cursor-pointer"
                            : "font-bold text-[#C4C4C4] cursor-pointer"
                        }
                        onClick={toggleReq}
                      >
                      ...
                      >
                        <h2>Requests</h2>
                        <p className="absolute top-[50%] right-[7%]">
                          _______________
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="w-full flex flex-col ">
                    ...
                    {/* main chat */}
                    <div className="h-full bg-[#FFF8FC] relative flex flex-col justify-end">
                      <div className="flex flex-row absolute  w-full mb-11">
